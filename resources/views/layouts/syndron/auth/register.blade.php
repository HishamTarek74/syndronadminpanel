                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <div class="text-center">
                                    <h3 class="">@lang('dashboard.auth.register.title')</h3>
                                </div>
                                <div class="form-body">
                                    <form class="row g-3" action="{{ route('register') }}" method="post">
                                        ...
                                        <div class="col-12">
                                            <label for="inputName"
                                                   class="form-label">@lang('dashboard.auth.register.name')</label>
                                            <input type="text"
                                        ...
                                        <div class="col-12">
                                            <label for="inputEmailAddress"
                                                   class="form-label">@lang('dashboard.auth.register.email')</label>
                                            <input type="email"
                                        ...
                                        <div class="col-12">
                                            <label for="inputChoosePassword"
                                                   class="form-label">@lang('dashboard.auth.register.password')</label>
                                        ...
                                        <div class="col-12">
                                            <label for="inputChoosePasswordConfirmation"
                                                   class="form-label">@lang('dashboard.auth.register.password_confirmation')</label>
                                            <div class="input-group" id="show_hide_password_confirmation">
                                                <input type="password"
                                                       name="password_confirmation"
                                                       class="form-control border-end-0 @error('password_confirmation') border-danger @enderror"
                                                       id="inputChoosePasswordConfirmation" autocomplete="current-password"
                                            ...
                                            @error('password_confirmation')<strong
                                                class="text-danger">{{$message}}</strong> @enderror
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary"><i
                                                        class="bx bxs-lock-open"></i>@lang('dashboard.auth.register.submit')
                                                </button>
                                            </div>
                                        </div>
                                    </form>
