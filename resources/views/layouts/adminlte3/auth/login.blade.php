                ...
                <div class="col-xl-5 col-md-6">
                    <div class="boxlogin__box rounded-xl p-4 py-lg-5">
                        <div class="text-center text-white mb-5">
                            <img style="width:200px" class="img-fluid img-hauto mb-4 rounded" src="@if(Settings::instance('loginLogo') && Settings::instance('loginLogo')->getFirstMediaUrl('loginLogo') != ""){{ Settings::instance('loginLogo')->getFirstMediaUrl('loginLogo') }} @else {{url('/')}}/loginPage/assets/img/ibtdi.png @endif" alt="">
