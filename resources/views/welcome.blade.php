        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 text-center">
                <div class="logomax mb-4 mb-lg-6">
                    <img
                        src="@if(Settings::instance('loginLogo') && Settings::instance('loginLogo')->getFirstMediaUrl('loginLogo') != ""){{ Settings::instance('loginLogo')->getFirstMediaUrl('loginLogo') }} @else {{url('/')}}/loginPage/assets/img/ibtdi.png @endif"
                        alt="">
                </div>
