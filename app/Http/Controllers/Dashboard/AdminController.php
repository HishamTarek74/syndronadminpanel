...
class AdminController extends Controller
{
    ...
    {
        $roles = Role::all();
        return view('dashboard.accounts.admins.create',compact('roles'));
    }
    ...
    {
        //dd($admin->getRoleNames()[0]);
        $roles = Role::all();
        return view('dashboard.accounts.admins.edit', compact('admin','roles'));
    }
