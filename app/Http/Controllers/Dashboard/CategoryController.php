...
class CategoryController extends Controller
{
    ...
    {
        $categories = Category::where('parent_id', 0)->filter()->paginate();
    ...
    {
        $features = Feature::where('category_id', $category->id)->paginate();

        return view('dashboard.categories.show', compact('category', 'features'));
    }
